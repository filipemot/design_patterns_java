...
Protype involve uma interface para clonar objetos e várias classes que o implementam.
Basicamente temos três participantes:

- Protoype: Interface Cloneable do próprio java
- ConcreteProtype: Implementação do Cloneable
- Cliente que utiliza a implentação
...
Uma outra forma é com Registro de classes estáticas
